            ...
            <div ref={ref} className="footer__section" >
                ...
                <li><a href='/#About' className="Link">ABOUT US</a></li>
                    ...
                    <div className="socials">
                        <a href="https://github.com/benisdp2" rel="noopener noreferrer" target="_blank"><i className='bx bxl-facebook-circle'></i></a>
                        <a href="https://github.com/benisdp2" rel="noopener noreferrer" target="_blank"><i className='bx bxl-instagram'></i></a>
                        <a href="https://github.com/benisdp2" rel="noopener noreferrer" target="_blank"><i className='bx bxl-twitter' ></i></a>
                        <a href="https://github.com/benisdp2" rel="noopener noreferrer" target="_blank"><i className='bx bxl-github'></i></a>
                    </div>
